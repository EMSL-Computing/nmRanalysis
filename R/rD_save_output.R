...
#' @param signals_codes 
#' @param results_to_save 
#' @param buck_step 
#' @param final_output 
#'
#' @details This function was forked directly from rDolphin (https://github.com/danielcanueto/rDolphin/tree/master/R). This function saves
