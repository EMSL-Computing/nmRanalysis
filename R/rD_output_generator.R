...
#' @param fitted_signals 
#' @param Ydata 
#' @param Xdata 
#' @param signals_parameters 
#' @param multiplicities 
#' @param buck_step 
#'
#' @details This function was forked directly from rDolphin (https://github.com/danielcanueto/rDolphin/tree/master/R). This function formats
